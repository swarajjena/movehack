...
const rows = [
  { id: '2', numeric: false, disablePadding: false, label: 'Truck Id' },
  { id: '3', numeric: false, disablePadding: false, label: 'Truck No' },
  { id: '4', numeric: false, disablePadding: false, label: 'Port of Operation' },
  { id: '5', numeric: false, disablePadding: false, label: 'Working Position' },
  { id: '6', numeric: false, disablePadding: false, label: 'Current Operation' },
  { id: '7', numeric: false, disablePadding: false, label: 'Current Status' },
...
class ToBeAllocatedTable extends React.Component {
  ...
  componentDidMount = () => {
    ...
    axios.get(`http://${hostAddress}/api/itv_logistics`)
      .then(response => {
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{n.truck_no}</TableCell>
                      <TableCell>{n.port_of_operation}</TableCell>
                      <TableCell>{n.working_position}</TableCell>
                      <TableCell>{n.current_operation}</TableCell>
